...
export default function CreateMockExam() {
  ...
  const canProceed = () => {
    switch (step) {
      case 1: return formData.test_name && formData.test_id;
          ...
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" required value={formData.test_id}
        ...
        {step === 3 && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { label: 'Exam ID', value: formData.test_id },
        ...
        {step === 4 && published && (
          <div className="text-center py-8 space-y-4 animate-fadeIn">
            ...
            <div className="flex gap-3 justify-center pt-4">
              ...
              <button onClick={() => { setStep(1); setPublished(false); setFormData({ ...formData, test_id: `exam_${Date.now()}`, test_name: '' }); }}
