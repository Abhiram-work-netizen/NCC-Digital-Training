...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden p-4 md:p-6">
      {/* Background image */}
      <img src={paradeImg2} alt="NCC Cadets" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <div className="w-full max-w-lg animate-fadeIn relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 md:gap-3 mb-5 md:mb-8">
          <div className={`flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-medium ${step >= 1 ? 'bg-navy-900 text-white' : 'bg-surface-200 text-surface-700'}`}>
          ...
          <div className="w-5 md:w-8 h-0.5 bg-surface-200" />
          <div className={`flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-medium ${step >= 2 ? 'bg-navy-900 text-white' : 'bg-surface-200 text-surface-700'}`}>
        ...
        <div className="ncc-glass-card p-8">
          {step === 1 ? (
            <form onSubmit={(e) => { e.preventDefault(); setStep(2); }} className="space-y-5">
              <h2 className="text-xl font-bold text-navy-900 mb-1">Create your account</h2>
            ...
            <form onSubmit={handleRegister} className="space-y-5">
              <h2 className="text-xl font-bold text-navy-900 mb-1">NCC Details</h2>
